...
import com.wangchao.mybatis.mapper.ParameterMapper;
...
public class ParameterMapperTest {
    ...
    public void testCheckLoginByParam() {
        ...
        User user = mapper.checkLoginByParam("张三","zhangsan123");//#{}
    ...
    public void testInsertUser() {
        ...
        mapper.insertUser(new User(null, "王五", "wangwu123", 18, "女", "wang_wu@qq.com"));
    }
    ...
    public void testCheckLogin() {
        SqlSession sqlSession = SqlSessionUtils.getSqlSession();
        ParameterMapper mapper = sqlSession.getMapper(ParameterMapper.class);
        User user = mapper.checkLogin("张三","zhangsan123");//#{}
        //User user = mapper.getUserByUsername("'张三'");//${}
        System.out.println(user);
    }
