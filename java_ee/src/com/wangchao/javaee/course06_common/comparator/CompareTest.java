...
public class CompareTest {
     ...
     *
     *  4. 对于自定义类来说，如果需要排序，我们可以让自定义类来实现Comparable接口，重写compareTo()方法，
     *     在compareTo(obj)方法中指明如何排序。
     */
    @Test
    public void test1() {
        String[] arr = new String[]{"AA", "CC", "GG", "MM", "FF", "OO", "RR"};
    ...
    public void test2() {
        ...
        arr[1] = new Goods("dellMouse", 58);
        arr[2] = new Goods("xiaomiMouse", 9.9);
        arr[3] = new Goods("huaweiMouse", 30);
